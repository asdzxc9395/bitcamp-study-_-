...
public class LessonHandler {
  ...
  //각 수업 목록을 개별적으로 관리할 변수
    ...
    public void addLesson() {
      ...
      lesson.contents = input.nextLine();

      System.out.print("시작일? ");
      lesson.start = Date.valueOf(input.nextLine());

      System.out.print("종료일? ");
      lesson.end = Date.valueOf(input.nextLine());

      System.out.print("총수업시간? ");
      lesson.total = input.nextInt();

      System.out.print("일수업시간? ");
      lesson.day = input.nextInt();
      input.nextLine();
