...
public class Exam23 {
  ...
  // 이 방식은 23 +(-23) 의 결과가 올바르게 나오지 않는다.
  
  // 2) 1's complement (1의 보수)
  //=> 모든 비트를 1이되는 수로 바꾼다. 즉 0을 1로, 1을 0으로 바꾼다.
  // 음수값을 변형할때 맨 앞자리 1은 바꾸지 않는다. 
  ...
  // (1)0000 0000 0000 0000 0000 0000 0000 0000 = 0 4바이트 최대값 초과해서0으로표기된다.
  // 음수를 더할때는 항상 결과에 1을 추가해야한다.
  //
  ...
  // 그래서 컴퓨터에서 음수를 메모리에 저장할 떄는
  // 암수와음수를 더할 때 정상적인 값이 나오도록
  // 2의 보수 방법으로 음수를 저장한다.
  //
