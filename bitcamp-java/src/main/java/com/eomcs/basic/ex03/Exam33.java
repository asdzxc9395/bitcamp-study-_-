...
public class Exam33 {
  public static void main (String[] args){
    ...
    System.out.println(3.141592f); // OK! (7자리)

    System.out.println(31415.92f); //OK! (7자리)
    System.out.println(314159.2f); //OK! (7자리)
    System.out.println(314159.26f); //값이 구겨진다.
    // 위 예제를 통해 일정 규칙을 찾을수 있다.
    // >> 4바이트 메모리에 저장할 수 있는 부동소수점은
    //    소수점의 위치에 상관없이 
    //    숫자의 개수가 7개이면 거의 정상적으로 저장하고
    //    꺼낼수 있다.
    //    이렇게 이렇게 정상적으로 넣고 꺼낼 수 있는 부동소수점의
    //    숫자 개수를 "유효자릿수"라고 부른다.
    // >> 주의!
    ...
    //    이 규칙에서 일부 부동소수점은 2진수로 정확하게 못하는 문제가 있다.

    System.out.println((1.1f + 0.2f)== 1.3);
  }
}