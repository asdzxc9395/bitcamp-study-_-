...
public class Exam04_3 {
    public static void main(String[] args) {
        ...
        */
        ...
        for (int i = 0; i < names.length; i++) //i = index의 약자 , 반복문의 값을 알려면 length명령어 선언
        ...
        // for (배열에서 꺼낸 값을 값을 저장할 변수 선언 : 배열주소) 문장;
        for (String name : names)  // name 변수 선언 >> 위에 names 라는 배열주소 지정
