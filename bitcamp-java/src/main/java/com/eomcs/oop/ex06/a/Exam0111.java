...
public class Exam0111 {
    ...
    public static void main(String[] args) {
        ...
        // 이렇게 상위 래퍼런스로 하위 클래스의 인스턴스를 
        // 가리킬수 있는 이유는
        // >> 하위 클래스의 인스턴스는 상위 클래스의 인스턴스 멤버를 갖고 있기 때문인다.
        // >> 그래서 상위클래스의 래퍼런스로 상위 클래스의 인스턴스 멤버
        //    사용을 보장한다.
        
        // Vehicle 변수 v2에 Bike 객체를 가리킨다면 ,
        v2 =b;
        ...
        //왜?
        // >> Bike 인스턴스에는 수퍼클래스인 Vehicle의 인스턴스를 가지고 있기 떄문이다.
    }
}
