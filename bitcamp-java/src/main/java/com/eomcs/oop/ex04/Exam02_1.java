...
public class Exam02_1 {
    public static void main(String[] args) throws Exception {
        ...
        char c = s1.charAt(1); // 문자열에 2번째 값 받는다.
        ...
        System.out.println(s1.contains("ll")); // 문자열이 안에 들어있나 없나 확인
        ...
        System.out.println(s1.equals("aaa")); // aaa != Hello
        System.out.println(s1.equals("Hello"));// Hello == Hello
        
        String s3 = new String("ABC가각");
        
        // 인스턴스에 들어 있는 문자 코드를 바이트 배열로 만들어 리턴한다.
        byte[] bytes = s3.getBytes(); // 문자열로 뽑는 메서드
        ...
        // => 형식을 갖춘 문자열을 만들기
        String s4 = String.format("%s님 반갑습니다", "홍길동"); // == printf (하지만리턴한다)
